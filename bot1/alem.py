...
while True:
    ...
    if nearest_city :
        if my_city['units']>nearest_city['units']:
            ...
            print(str(my_city['x'])+" "+str(my_city['y'])+" "+str(nearest_city['x'])+" "+str(nearest_city['y']), file=sys.stderr, flush=True)
        ...
        if 2<=count_my_cities(cities, my_owner='p1'):
            print(str(second_closest_city['x'])+" "+str(second_closest_city['y'])+" " +str(nearest_city['x'])+" "+str(nearest_city['y']))   
        else:
            print("", flush=True)
